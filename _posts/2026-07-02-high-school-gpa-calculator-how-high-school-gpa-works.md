...
meta_title: "High School GPA Calculator: Weighted vs Unweighted"
meta_description: Calculate your high school GPA on the 4.0 scale, see how
  weighted and unweighted differ, and what AP or honors classes add.
...
At [StudentCalcTools](https://studentcalctools.com/), the goal is to make that answer easier. This guide explains how high school GPA works, how to calculate it manually, where credits matter, how weighted classes affect GPA, and when to use a calculator for a faster result.
...
1. Final GPA after the semester ends
2. Final cumulative GPA after graduation
...
If you are trying to calculate the final exam score needed in one class, use the [final grade calculator](https://studentcalctools.com/final-grade-calculator/).

If you are trying to calculate your GPA after final grades are entered, use the [GPA calculator](https://studentcalctools.com/gpa-calculator/).
...
If your school shows number grades first, you can use a [grade calculator](https://studentcalctools.com/grade-calculator/) to estimate course grades before converting them into GPA points.
...
If finals are coming up, use a [study time planner](https://studentcalctools.com/study-time-planner/) to prioritize the classes where a better final grade can make the biggest GPA difference.
...
Use the [class rank calculator](https://studentcalctools.com/class-rank-calculator/) if you are trying to understand how GPA may compare with others in your class.
